export const axlt = [
  {
    inputs: [{ internalType: 'contract IBEP20', name: 'usdt_', type: 'address' }],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'address', name: 'recipient', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'lineLevel', type: 'uint256' },
    ],
    name: 'BuyLine',
    type: 'event',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'lineNumber', type: 'uint256' }],
    name: 'getPriceLine',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
